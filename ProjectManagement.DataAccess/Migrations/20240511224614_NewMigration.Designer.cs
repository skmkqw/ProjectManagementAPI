...
namespace ProjectManagement.DataAccess.Migrations
{
    ...
    [Migration("20240511224614_NewMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjectManagement.Core.Identity.AppUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AppUserProject", b =>
                {
                    b.HasOne("ProjectManagement.Core.Identity.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ProjectManagement.Core.Entities.ProjectTaskEntity", b =>
                {
                    b.HasOne("ProjectManagement.Core.Identity.AppUser", "AssignedUser")
                        .WithMany("Tasks")
            ...
            modelBuilder.Entity("ProjectManagement.Core.Entities.ProjectUserEntity", b =>
                {
                    ...
                    b.HasOne("ProjectManagement.Core.Identity.AppUser", "User")
                        .WithMany("ProjectUsers")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
